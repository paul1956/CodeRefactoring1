...
Namespace EditorExtensions
    Module ProjectHelpers
        ...
        Public Function GetSolutionItemsProject() As Project
            Dim solution As Solution2 = TryCast(Command1Package.DTE.Solution, Solution2)
        ...
        Public Function GetAllProjects() As IEnumerable(Of Project)
            Return Command1Package.DTE.Solution.Projects.Cast(Of Project)().
                SelectMany(AddressOf GetChildProjects).
                Union(Command1Package.DTE.Solution.Projects.Cast(Of Project)()).
        ...
        Public Function GetRootFolder(Optional project As Project = Nothing) As String
            Try
                ...
                If project Is Nothing OrElse project.Collection Is Nothing Then
                    Dim doc As Document = Command1Package.DTE.ActiveDocument
        ...
        Public Function GetActiveProject() As Project
            Try
                Dim activeSolutionProjects As Array = TryCast(Command1Package.DTE.ActiveSolutionProjects, Array)
                ...
                End If
            Catch ex As Exception
                Logger.Log("Error getting the active project" & ex.Message)
            End Try
...
#Region "ToAbsoluteFilePath()"
        ...
        Public Function ToAbsoluteFilePath(relativeUrl As String, projectRoot As String, baseFolder As String) As String
...
#End Region
        ...
        Public Function GetCurentTextBuffer() As ITextBuffer
        ...
        Public Function GetCurentTextView() As IWpfTextView
            Dim componentModel As IComponentModel = GetComponentModel()
            If componentModel Is Nothing Then
                Return Nothing
            End If
            Dim editorAdapter As IVsEditorAdaptersFactoryService = componentModel.GetService(Of IVsEditorAdaptersFactoryService)()

            Return editorAdapter.GetWpfTextView(GetCurrentNativeTextView())
        End Function

        Public Function GetCurrentNativeTextView() As IVsTextView
            Dim textManager As IVsTextManager = DirectCast(ServiceProvider.GlobalProvider.GetService(GetType(SVsTextManager)), IVsTextManager)

            Dim activeView As IVsTextView = Nothing
            ErrorHandler.ThrowOnFailure(textManager.GetActiveView(1, Nothing, activeView))
            Return activeView
        End Function

        Public Function GetComponentModel() As IComponentModel
            Return DirectCast(Command1Package.GetGlobalService(GetType(SComponentModel)), IComponentModel)
        End Function
        ...
        Public Iterator Function GetSelectedItemPaths(Optional dte As DTE2 = Nothing) As IEnumerable(Of String)
            Dim items As Array = DirectCast(If(dte, Command1Package.DTE).ToolWindows.SolutionExplorer.SelectedItems, Array)
        ...
        Public Iterator Function GetSelectedProjects() As IEnumerable(Of Project)
            Dim items As Array = DirectCast(Command1Package.DTE.ToolWindows.SolutionExplorer.SelectedItems, Array)
            For Each selItem As UIHierarchyItem In items
        ...
        Public Function CheckOutFileFromSourceControl(fileName As String) As Boolean
            Try
                Dim dte As DTE2 = Command1Package.DTE
        ...
        Public Function GetSolutionFolderPath() As String
            Dim solution As EnvDTE.Solution = Command1Package.DTE.Solution
        ...
        Public Function FixAbsolutePath(absolutePath As String) As String
        ...
        Friend Function GetProjectItem(fileName As String) As ProjectItem
            Try
                Return Command1Package.DTE.Solution.FindProjectItem(fileName)
