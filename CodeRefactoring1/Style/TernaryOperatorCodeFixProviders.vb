...
Namespace Style
    ...
    Public Class TernaryOperatorFromIifCodeFixProvider
        ...
        Public Overrides ReadOnly Property FixableDiagnosticIds() As ImmutableArray(Of String) =
            ImmutableArray.Create(TernaryOperator_IifDiagnosticId)
    ...
    Public Class TernaryOperatorWithAssignmentCodeFixProvider
        ...
        Public Overrides ReadOnly Property FixableDiagnosticIds() As ImmutableArray(Of String) =
            ImmutableArray.Create(TernaryOperator_AssignmentDiagnosticId)
    ...
    Public Class TernaryOperatorWithReturnCodeFixProvider
        ...
        Public Overrides ReadOnly Property FixableDiagnosticIds As ImmutableArray(Of String) =
            ImmutableArray.Create(TernaryOperator_ReturnDiagnosticId)
