...
Namespace Usage
    ...
    Public Class UnusedParametersAnalyzer
        ...
        Friend Const Title As String = "Unused parameters."
        Friend Const Message As String = "Parameter '{0}' is not used."
...
You should delete the parameter in such cases."
        ...
        DiagnosticIds.UnusedParametersDiagnosticId,
        Title,
        Message,
        ...
        True,
        Description,
        HelpLink.ForDiagnostic(DiagnosticIds.UnusedParametersDiagnosticId),
            ...
            If methodOrConstructor.Statements.Any() Then
                ...
                For Each parameter As KeyValuePair(Of VisualBasic.Syntax.ParameterSyntax, IParameterSymbol) In parameters
                    ...
                    If Not dataFlowAnalysis.ReadInside.Contains(parameterSymbol) AndAlso
                        ...
                        context = Me.CreateDiagnostic(context, parameter.Key)
                    End If
                Next
            Else
                For Each parameter As ParameterSyntax In parameters.Keys
                    context = Me.CreateDiagnostic(context, parameter)
                Next
            End If
        End Sub
