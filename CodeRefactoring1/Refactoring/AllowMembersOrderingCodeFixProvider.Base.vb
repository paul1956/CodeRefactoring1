...
Namespace Refactoring
    Public MustInherit Class BaseAllowMembersOrderingCodeFixProvider
        ...
        Private Async Function AllowMembersOrderingAsync(document As Document, typeBlock As TypeBlockSyntax, cancellationToken As CancellationToken) As Task(Of Document)
            ...
            Dim orderChanged As Boolean = Me.TryReplaceTypeMembers(typeBlock, membersDeclaration, membersDeclaration.OrderBy(Function(member As DeclarationStatementSyntax) member, Me.GetMemberDeclarationComparer(document, cancellationToken)), newTypeBlock)
